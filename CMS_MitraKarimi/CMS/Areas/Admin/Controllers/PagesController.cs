...
//            _webHostEnvironment = webHostEnvironment;
        ...
        public ActionResult Create([Bind(Include = "PageID,GroupID,Title,ShortDescription,Text,Visit,ImageName,ShowInSlider,CreateDate,Tags")] Page page,FileStream imgUp)
        {
            if (ModelState.IsValid)
            {
                ...
                if (imgUp != null)
                {
                    pageRepository.SaveImage(imgUp);
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PageID,GroupID,Title,ShortDescription,Text,Visit,ImageName,ShowInSlider,CreateDate,Tags")] Page page, FileStream imgUp)
        {
            if (ModelState.IsValid)
            {
                if (imgUp != null)
 ...
 //                   string webRootPath = _webHostEnvironment.WebRootPath;
                    ...
                    {
                     //   System.IO.File.Delete(webRootPath + "/PageImages/" + page.ImageName);
                    }
                    pageRepository.SaveImage(imgUp);
                }
